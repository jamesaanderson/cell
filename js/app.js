...
(function() {
  $(function() {
    var Game, HEIGHT, InputHandler, Sprite, WIDTH, bacteriaSprite, cell, cellSprite, game, init, input, main, render, run, update, virusSprite, viruses;
    Game = (function() {
